...
@Component({
  selector: 'app-lessons-hours-instructor-popup',
  templateUrl: './lessons-hours-instructor-popup.component.html',
  styleUrls: ['./lessons-hours-instructor-popup.component.css']
})
export class LessonsHoursInstructorPopupComponent {
