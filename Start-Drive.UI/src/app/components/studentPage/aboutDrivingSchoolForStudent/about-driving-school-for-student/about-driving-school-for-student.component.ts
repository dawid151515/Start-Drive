...
@Component({
  selector: 'app-about-driving-school-for-student',
  templateUrl: './about-driving-school-for-student.component.html',
  styleUrls: ['./about-driving-school-for-student.component.css']
})
export class AboutDrivingSchoolForStudentComponent {
