...
@Component({
  selector: 'app-main-calendar-days-for-student',
  templateUrl: './main-calendar-days-for-student.component.html',
  styleUrls: ['./main-calendar-days-for-student.component.css']
})
export class MainCalendarDaysForStudentComponent {
  ...
  //free hour during the day of riding
